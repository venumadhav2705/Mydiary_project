...
<a href="./signout" style="color:red;float:right">signout</a> <!-- here we used float right to send sign out button to right side --> 
...
<c:forEach items="${entrieslist}" var="e"> <!--  manaki list of objects controller nunchi vastai vatini ikkada loop run chesi display
 ...
 <tr>
 <td>
 <fmt:formatDate value="${e.entrydate}" pattern="dd/MM/yyy"/>  <!-- fmt tag manam d/m/year correct ga format radaniki -->
  </td>
